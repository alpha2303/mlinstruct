...
class BaseTrainer(ABC):
    ...
    def __init__(
        ...
        self._early_stopper: EarlyStopper | None = early_stopper
    ...
    def add_early_stop(self, patience: int = 2, min_delta: float = 0.01) -> Self:
        ...
        Args:
            patience (int, optional): The number of epochs with no improvement after
                which training will be stopped. Defaults to 2.
            min_delta (float, optional): The minimum change in the monitored quantity
                to qualify as an improvement. Defaults to 0.01.
        """
