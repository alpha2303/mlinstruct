...
from train.model_proxy import BaseModelProxy
...
class CheckpointWriter:
    ...
    def create_checkpoint(
        ...
        """
        if is_best:
            model_proxy.save_weights(epoch, vloss, self.__model_save_dir_path, "best")

        model_proxy.save_weights(epoch + 1, vloss, self.__model_save_dir_path, "last")
